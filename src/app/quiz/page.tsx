        ...
        <div className={`grid gap-4 ${step.multi ? "grid-cols-2 sm:grid-cols-3" : "grid-cols-1 sm:grid-cols-2"}`}>
          {step.options.map((opt) => {
            ...
            return (
              ...
              >
                <div className="icon-container w-10 h-10 rounded-lg mb-2 flex items-center justify-center">
                  {optionIcon[opt] ?? <CheckCircleIcon className="w-5 h-5 text-emerald-400 rounded-sm" />}
                </div>
